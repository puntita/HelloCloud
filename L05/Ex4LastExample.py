...
class Order_Product(Base):
    ...
    class Order(Base):
        ...
        prod1 = products(name="Oreo")
        prod2 = products(name="Hide and Seek")
        prod3 = products(name="Marie")
        prod4 = products(name="Good Day")
        ...
        print("Orsers array of prod1: ")
        print(prod1.orders)
        print("Orders array of prod2: ")
        print(prod2.orders)
        print("Orsers array of prod3: ")
        print(prod3.orders)
